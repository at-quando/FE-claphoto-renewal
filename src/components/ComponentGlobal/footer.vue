          ...
          <div class="col-md-3">
            <div class="widget photostram">
              ...
              <ul class="cp-photo-grid">
                <li><img src="../../assets/images/ps1.jpg" alt=""></li>
                <li><img src="../../assets/images/ps2.jpg" alt=""></li>
                <li><img src="../../assets/images/ps3.jpg" alt=""></li>
                <li><img src="../../assets/images/ps4.jpg" alt=""></li>
                <li><img src="../../assets/images/ps5.jpg" alt=""></li>
                <li><img src="../../assets/images/ps6.jpg" alt=""></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
            <div class="widget cp-tags">
              <h3>Tags</h3>
              <ul class="tags">
                <li> <a href=""> Design</a> <a href=""> General</a> <a href=""> Life Style</a> <a href=""> Travel</a> <a href=""> Wordpress</a> <a href=""> Design</a> <a href=""> Photography</a> <a href=""> General</a> <a href=""> Life Style</a> <a href=""> Travel</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
